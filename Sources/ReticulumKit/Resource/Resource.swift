...
// multi-segment size splits (RK-14).
...
public actor Resource {
    ...
    /// When set, this Resource completes a pending `Link.request` (Python `is_response`).
    public private(set) var responseRequestId: Data?
    ...
    private var isResponseResource: Bool
    ...
    public static func incoming(
        ...
        return Resource(
            ...
            responseRequestId: advertisement.isResponse ? advertisement.requestId : nil,
            isResponseResource: advertisement.isResponse
        )
    }
    ...
    private init(
        ...
        self.isResponseResource = isResponseResource
    }
    ...
    public func advertise() async throws {
        ...
        if isResponseResource { flags |= 0x10 } // is_response
